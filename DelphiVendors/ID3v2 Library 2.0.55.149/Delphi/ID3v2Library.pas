//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v2 Library 2.0.55.149 © 3delite 2010-2018                                                                             *
...
Const
    ID3V2LIBRARY_VERSION = $020055149;
...
var
    ...
    ReversedFlags: Word;
    DataLengthIndicatorValue, DataLengthIndicatorValueSyncSafe: Cardinal;
begin
    try
        for i := 0 to FrameCount - 1 do begin
            ...
            if MajorVersion = 3 then begin
                ...
                DataLengthIndicatorValue := Frames[i].Stream.Size;
                SyncSafe(DataLengthIndicatorValue, DataLengthIndicatorValueSyncSafe, 4);
        ...
        if TLEN <> '' then begin
            ...
            if SourceFileType = sftMPEG then begin
                if MPEGInfo.VBR then begin
                    ...
                    FPlayTime := MPEGInfo.FrameCount * SamplesPerFrame / MPEGInfo.SampleRate;
                end else begin
                    //* Only valid for CBR
                    ID3v1Size := 0;
                    ...
                    FPlayTime := ((Self.FileSize - Self.Size - ID3v1Size) / Self.Bitrate * 8) / 1000;
                end;
            end;
        end;
    end;
